...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/vmware-modules/vmware-modules-1.0.0.25.ebuild,v 1.3 2009/08/25 11:33:14 fauli Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PV}-vmmon-hostif-CAPS.patch"
}
