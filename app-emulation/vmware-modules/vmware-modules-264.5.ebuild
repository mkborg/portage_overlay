...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/vmware-modules/Attic/vmware-modules-264.5.ebuild,v 1.6 2014/04/12 18:28:49 dilfridge dead $
...
src_prepare() {
	...
	kernel_is ge 3 10 0 && epatch "${FILESDIR}/${PV_MAJOR}-3.10.0.patch"
        ...
        kernel_is ge 4 0 1 && epatch "${FILESDIR}/${PV_MAJOR}-4.0.1-vmci-kernel.patch"
        kernel_is ge 4 1 15 && epatch "${FILESDIR}/${PV_MAJOR}-4.1.15-VNetFilterHookFn.patch"
